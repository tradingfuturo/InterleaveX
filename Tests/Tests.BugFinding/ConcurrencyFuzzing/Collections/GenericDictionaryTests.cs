...
{
    /// <summary>
    /// Runs the dictionary race tests against genuinely parallel threads rather than an explored
    /// schedule. See <see cref="GenericListTests"/> for why these counterparts exist.
    /// </summary>
    public class GenericDictionaryTests : DataRaceChecking.GenericDictionaryTests
    {
